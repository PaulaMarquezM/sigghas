...
export function NuevaSesionDialog({ horarioId, opciones }: { horarioId: string; opciones: OpcionesManuales }) {
  ...
  return <>
    <button type="button" onClick={() => setAbierto(true)} disabled={pendiente} className="inline-flex items-center gap-2 rounded-lg bg-[#1D3FD9] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#1733B5] disabled:cursor-wait disabled:opacity-60"><Plus className="size-4" />Agregar clase</button>
