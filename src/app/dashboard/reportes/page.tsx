...
export default async function ReportesPage() {
  ...
  const { data } = await supabase
    .from("sesiones")
    .select("docente_id,espacio_id,hora_inicio,hora_fin,docentes:docente_id(perfiles(nombre)),espacios:espacio_id(nombre)")
